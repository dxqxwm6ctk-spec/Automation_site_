...
**How to apply:** Before starting or continuing any phase described in PROJECT_STATUS.md, spot-check the files/DB state it claims about. If it's wrong, correct it as part of your update rather than propagating the error.
